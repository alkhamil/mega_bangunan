...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/rekapitulasi', 'LaporanCtrl@rekapitulasi')->name('laporan.rekapitulasi');
    Route::get('/rekapitulasi/cari', 'LaporanCtrl@rekapitulasiCari')->name('laporan.rekapitulasiCari');
